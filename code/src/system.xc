...
#if defined(BL_PLATFORM_WIN32)
extern BLVoid _GpuIntervention(HWND, BLBool);
...
BLVoid
blSystemRun(IN BLAnsi* _Appname, IN BLU32 _Width, IN BLU32 _Height, IN BLBool _Fullscreen, IN BLBool _Profiler, IN BLEnum _Quality, IN BLVoid(*_Begin)(BLVoid), IN BLVoid(*_Step)(BLF32), IN BLVoid(*_End)(BLVoid))
{
#if defined(BL_PLATFORM_UWP)
...
BLVoid
blSystemEmbedRun(IN BLS32 _Handle, IN BLVoid(*_Begin)(BLVoid), IN BLVoid(*_Step)(BLF32), IN BLVoid(*_End)(BLVoid))
{
