...
#define SPACTION_SKEW_INTERNAL			3
#define SPACTION_ALPHA_INTERNAL			4
#define SPACTION_DEAD_INTERNAL			5
/* UI Action Type */
...
#endif
/* Hash Table*/
static const BLU32 CRCCODE_INTERNAL[] = {
...
#else
#	if _DEBUG
#		define GL_CHECK_INTERNAL(call) {call; GLenum  _err = glGetError();if (GL_NO_ERROR != _err) {printf("gl error code: %d", _err); assert(0);}}
