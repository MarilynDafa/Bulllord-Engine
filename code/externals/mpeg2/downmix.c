		      ...
		      level_t clev, level_t slev)
{
	...
	case CONVERT (A52_3F1R, A52_MONO):
	    adjust = (level_t)DIV (LEVEL_3DB, LEVEL (1) + clev + MUL_C (slev, 0.5));
	    break;

	case CONVERT (A52_3F1R, A52_STEREO):
	    adjust = (level_t)DIV (1, LEVEL (1) + clev + MUL_C (slev, LEVEL_3DB));
	    break;

	case CONVERT (A52_2F2R, A52_MONO):
	    adjust = (level_t)DIV (LEVEL_3DB, LEVEL (1) + slev);
	    break;

	case CONVERT (A52_2F2R, A52_STEREO):
	case CONVERT (A52_3F2R, A52_3F):
	    adjust = (level_t)DIV (1, LEVEL (1) + slev);
	    break;

	case CONVERT (A52_3F2R, A52_MONO):
	    adjust = (level_t)DIV (LEVEL_3DB, LEVEL (1) + clev + slev);
	    break;

	case CONVERT (A52_3F2R, A52_STEREO):
	    adjust = (level_t)DIV (1, LEVEL (1) + clev + slev);
	    break;
		       ...
		       level_t clev, level_t slev)
{
	...
	coeff[0] = coeff[1] = (level_t)MUL_C (level, LEVEL_6DB);
	return 3;
	...
	coeff[1] = (level_t)MUL_C (MUL_L (level_3db, clev), LEVEL_PLUS6DB);
	return 7;
	...
	coeff[0] = coeff[2] = level_3db;
	coeff[1] = (level_t)MUL_C (MUL_L (level_3db, clev), LEVEL_PLUS6DB);
	coeff[3] = (level_t)MUL_L (level_3db, slev);
	return 15;
