...
QT_MOC_LITERAL(1, 6, 9), // "mouseMove"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 1), // "x"
QT_MOC_LITERAL(4, 19, 1) // "y"

    },
    "Image\0mouseMove\0\0x\0y"
};
...
void Image::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseMove((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Image::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Image::mouseMove)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Image::mouseMove(int _t1, int _t2)
{
